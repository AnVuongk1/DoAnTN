          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Nhập" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="price">Giá</label>
                  <input type="text" class="form-control" id="price" name="price" placeholder="Giá" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Số lượng</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Số lượng" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  <label for="store">Trạng thái hiển thị</label>
