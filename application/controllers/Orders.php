...
class Orders extends Admin_Controller
{
	...
	*/
	public function update($id)
	{
		...
		$this->data['page_title'] = 'Sửa đơn hàng';
	...
	public function printDiv($id)
	{
		...
		if ($id) {
			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>Mã hóa đơn:</b> ' . $order_data['bill_no'] . '<br>
			        <b>Tên khách:</b> ' . $order_data['customer_name'] . '<br>
			    ...
			    <div class="row">
			      ...
			      <div class="col-xs-6 pull pull-right">
			        ...
			        <div class="table-responsive">
			          <table class="table">
			            <tr>
			              <th style="width:50%">Giá ban đầu:</th>
			              <td>' . $order_data['gross_amount'] . '</td>
			            </tr>';

			if ($order_data['service_charge'] > 0) {
				$html .= '<tr>
				              <th>Thuế kho (' . $order_data['service_charge_rate'] . '%)</th>
			...
			if ($order_data['vat_charge'] > 0) {
				$html .= '<tr>
				              <th>Thuế VAT (' . $order_data['vat_charge_rate'] . '%)</th>
