    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            $availability = ($value['availability'] == 1) ? '<span class="label label-success">Kích hoạt</span>' : '<span class="label label-warning">Không kích hoạt</span>';

            $qty_status = '';
            if($value['qty'] <= 10 && $value['qty'] > 0) {
                $qty_status = '<span class="label label-warning">Ít!</span>';
            } else if($value['qty'] <= 0) {
